...
import { getDataToLocalStorage, setDataToLocalStorage } from "../Utilities/Utilities";
...
const CoffeDetails = () => {
    ...
    useEffect(() => {
        const selectId = allData.find(coffee => coffee.id == id);
        setCoffeeId(selectId);
        const favorites = getDataToLocalStorage()
        const isExist = favorites.find(coffee => coffee.id == selectId.id);
        if(isExist){
            setIsFavorite(true)
        }
    }, [allData, id])
        ...
        <div className='my-12'>
            ...
            <div className='flex justify-between items-center my-6'>
                ...
                <div>
                    <button
                          disabled={isFavorite}
                        onClick={() => handleFavorite(coffeeId)}
